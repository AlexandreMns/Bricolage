      ...
      <tr>
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="margin: 20px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <td style="padding: 20px;">
            ...
            <a href="http://localhost:3000/profile/resetpassword" style="display: inline-block; padding: 15px 35px; background-color: #007bff; color: #ffffff; text-decoration: none; border-radius: 25px; font-size: 18px; border: 2px solid #007bff; transition: background-color 0.3s ease;">Repor Password</a>
            </p>
            <p style="color: #666666; margin: 20px 0; line-height: 1.6; text-align: center;">Se o botão não funcionar, você também pode clicar <a href="http://localhost:3000/profile/resetpassword" style="color: #007bff; text-decoration: none;">aqui</a></p>
